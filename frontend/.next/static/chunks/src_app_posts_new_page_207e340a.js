...
"[project]/src/app/posts/new/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NewPost() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8000/api/blogs", postData);
            ...
            setErrorMsg(((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.detail) || error.message);
        } finally{
            setLoading(false);
        }
    }
...
_s(NewPost, "CmKJCaSq1sCKJhn9wxSDY6e2ZHU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_posts_new_page_207e340a.js.map