...
function PostDetail(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PostDetail.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8000/api/blogs/".concat(id)).then({
                "PostDetail.useEffect": (res)=>setPost(res.data)
            }["PostDetail.useEffect"]).catch({
                "PostDetail.useEffect": ()=>setError("Post not found")
            }["PostDetail.useEffect"]);
        }
    }["PostDetail.useEffect"], [
        id
    ...
    const handleDelete = async ()=>{
        if (confirm("Are you sure you want to delete this post?")) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("http://localhost:8000/api/blogs/".concat(id));
                router.push("/posts");
            } catch (e) {
...
_s(PostDetail, "LGIW9d2ubS1lcAz0nxLd8JSdo8w=", false, function() {
    return [
...
//# sourceMappingURL=src_app_posts_%5Bid%5D_page_24b82e7f.js.map